                    ...
                    <table className="table">
                        ...
                        <tr>
                            ...
                            <div className="d-flex align-items-center mt-2">
                                <img src="assets/img/vegetable-item-2.jpg" className="img-fluid rounded-circle" style={{width: 90, height: 90}} alt />
                            </div>
                            </th>
                        ...
                        <tr>
                            <th scope="row">
                            <div className="d-flex align-items-center mt-2">
                                <img src="assets/img/vegetable-item-5.jpg" className="img-fluid rounded-circle" style={{width: 90, height: 90}} alt />
                            </div>
                            </th>
                        ...
                        <tr>
                            <th scope="row">
                            <div className="d-flex align-items-center mt-2">
                                <img src="assets/img/vegetable-item-3.png" className="img-fluid rounded-circle" style={{width: 90, height: 90}} alt />
                            </div>
                            </th>
