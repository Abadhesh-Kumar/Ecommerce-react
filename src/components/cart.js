            ...
            <div className="table-responsive">
                ...
                <tbody>
                    ...
                    <th scope="row">
                        ...
                        <img src="assets/img/vegetable-item-3.png" className="img-fluid me-5 rounded-circle" style={{width: 80, height: 80}} alt />
                        </div>
                    </th>
                    <td>
                    ...
                    <th scope="row">
                        <div className="d-flex align-items-center">
                        <img src="assets/img/vegetable-item-5.jpg" className="img-fluid me-5 rounded-circle" style={{width: 80, height: 80}} alt />
                        </div>
                    </th>
                    <td>
                    ...
                    <th scope="row">
                        <div className="d-flex align-items-center">
                        <img src="assets/img/vegetable-item-2.jpg" className="img-fluid me-5 rounded-circle" style={{width: 80, height: 80}} alt />
                        </div>
                    </th>
                    <td>
